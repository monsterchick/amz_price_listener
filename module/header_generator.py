...
user_agents = [
    ...
    "Mozilla/5.0 (Linux; Android 10; Pixel 3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.63 Mobile Safari/537.36",
...
random_user_agents = random.sample(user_agents,10)
